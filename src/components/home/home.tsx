...
render(){
    return <div className="homeDesign">
        ...
        <h2>Oldalunkon könnyedén kölcsönözhet, kereshet DVD-ket, többféle szempont szerint szűrheti vagy sorrendezheti 
            azokat.
        </h2>
        ...
        <h3>What is Lorem Ipsum?
            ...
            sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero, written 
            in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of 
